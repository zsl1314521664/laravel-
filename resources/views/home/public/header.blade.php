...
{{--    @else--}}
        <!-- Login status -->
            <!-- Login status -->
            <div id="login-reg">
                <span> <a href="/login" target="_blank">登录</a></span>
            </div>
            <!-- /.Login status -->
            <div id="login-reg">
                <span> <a href="/emailregister" target="_blank">注册</a></span>
            </div>
            <!-- /.Login status -->
                            ...
                            @if(!empty($catetwo[$k]))
                                <ul class="sub-menu">
                                    @foreach($catetwo[$k] as $m=>$n)
                                        <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-4317"><a href="{{ url('/lists/'.$n->cate_id) }}">{{ $v->cate_name }}</a></li>
                                    @endforeach
